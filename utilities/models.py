...
class UNet2D(nn.Module):
    ...
    def __init__(self, out_classes=2, up_sample_mode='conv_transpose'):
        ...
        # Downsampling Path
        self.down_conv1 = DownBlock2D(1, 64) # 3 input channels --> 64 output channels
        self.down_conv2 = DownBlock2D(64, 128) # 64 input channels --> 128 output channels
        self.down_conv3 = DownBlock2D(128, 256) # 128 input channels --> 256 output channels
        self.down_conv4 = DownBlock2D(256, 512) # 256 input channels --> 512 output channels
        # Bottleneck
        self.double_conv = DoubleConv2D(512, 1024)
        # Upsampling Path
        self.up_conv4 = UpBlock2D(512 + 1024, 512, self.up_sample_mode) # 512 + 1024 input channels --> 512 output channels
        self.up_conv3 = UpBlock2D(256 + 512, 256, self.up_sample_mode)
        self.up_conv2 = UpBlock2D(128 + 256, 128, self.up_sample_mode)
        self.up_conv1 = UpBlock2D(128 + 64, 64, self.up_sample_mode)
        # Final Convolution
