...
#SBATCH --job-name=getpredstmp_valid
...
X_DIR=/home/hluo/scratch/select_dauer_data_512/original/valid
Y_DIR=/home/hluo/scratch/select_dauer_data_512/ground_truth/valid
BATCH_SIZE=1
NUM_WORKERS=1
MODEL_PATH=$1
SAVE_DIR=$2
