...
def parse_arguments():
    ...
    parser.add_argument("--alpha", type=float, default=1, help="Weight for class 0 in Focal Loss")
    parser.add_argument("--beta", type=float, default=1, help="Weight for class 1 in Focal Loss")
