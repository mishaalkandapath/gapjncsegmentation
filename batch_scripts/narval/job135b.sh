...
python ~/gapjncsegmentation/unet_comboloss_no_wandb.py \
  ...
  --valid_img_dir_list /home/hluo/scratch/111_120_3x512x512_no_overlap/original \
  --valid_gt_dir_list /home/hluo/scratch/111_120_3x512x512_no_overlap/original \
  --epochs $EPOCHS \
