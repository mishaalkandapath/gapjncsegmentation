...
TRAIN_STRIDE=128
VALID_STRIDE=128
TRAIN_X_DIRS="/home/hluo/scratch/data/150_170small_${CROP_DEPTH}x${CROP_SIZE}x${CROP_SIZE}_stride128/original /home/hluo/scratch/data/${TRAIN_SLICES}_${CROP_DEPTH}x${CROP_SIZE}x${CROP_SIZE}_stride${TRAIN_STRIDE}/original /home/hluo/scratch/data/100_110_${CROP_DEPTH}x${CROP_SIZE}x${CROP_SIZE}_stride${TRAIN_STRIDE}/original"
TRAIN_Y_DIRS="/home/hluo/scratch/data/150_170small_${CROP_DEPTH}x${CROP_SIZE}x${CROP_SIZE}_stride128/ground_truth /home/hluo/scratch/data/${TRAIN_SLICES}_${CROP_DEPTH}x${CROP_SIZE}x${CROP_SIZE}_stride${TRAIN_STRIDE}/ground_truth /home/hluo/scratch/data/100_110_${CROP_DEPTH}x${CROP_SIZE}x${CROP_SIZE}_stride${TRAIN_STRIDE}/ground_truth"
